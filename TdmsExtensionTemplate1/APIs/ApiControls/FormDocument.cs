...
public class FormDocument : ACommands
{
    public TDMSInputForm _form;
    public TDMSAttribute Attribute;
    public TDMSAttribute OldAttribute;

    public FormDocument(TDMSApplication application, TDMSObject thisObject, TDMSInputForm form, Tdms.Log.ILogger<ExportClassifiersCommand> logger, TDMSAttribute attribute, BoolRef Cancel, TDMSAttribute oldattribute) :
