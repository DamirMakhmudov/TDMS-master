...
public class iCommand : CommandBase
{
    public iCommand(TDMSApplication application, TDMSObject thisObject, Tdms.Log.ILogger<ExportClassifiersCommand> logger, ILifetimeScope scope) : base(application, thisObject, logger, scope) { }
...
public class iCommandw : CommandBase
{
    public iCommandw(TDMSApplication application, TDMSObject thisObject, Tdms.Log.ILogger<ExportClassifiersCommand> logger, ILifetimeScope scope) : base(application, thisObject, logger, scope) { }
    public void Execute(string handle)
    {
        //_application.GetObjectByHandle(handle);
        _logger.Info(handle);
